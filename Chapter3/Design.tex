...
\end{equation}
This sets the limiting velocity as $v=1.9m/sec$ based on the $Z_{cg}=190mm$ and $d=168$ as shown in  Figure \ref{fig:loadDistribution} and \ref{fig:LatOverturn}. Where, R equals the minimum turning radius of the vehicle which is $415mm$ as given in Table \ref{tb:specifications}.
...
\section{Summary}
Requirement of an overactuated system was discussed. The advantage of the proposed kinematic design over other redundantly actuated system discussed.
Design calculations for the proposed  RARS mobile manipulator are presented.
Different aspects based on the requirements of radiation inspection around cyclotron was taken into account.
Advantage of positively steered wheels over caster wheel was highlighted for the proposed mobile robot. 
