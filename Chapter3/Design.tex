...
\begin{figure}
 	...
 	\end{minipage}
 \end{figure}
 \subsubsection {Selection of Motor and Gearbox}
...
\subsection{Design of Steering System }
 \begin{figure}
 	\centering
	\includegraphics[width=\linewidth,keepaspectratio]{Chapter3/fig/steer}
	\captionof{figure}{Davis steering mechanism }
	\label{fig:davis} 
\end{figure} 
\begin{figure}
	\centering
	\begin{minipage}{.5\textwidth}
		...
		\captionof{figure}{Wheel Ground Interaction}
		\label{fig:steerTorq}
	\end{minipage}%
	\begin{minipage}{.5\textwidth}
		\centering
