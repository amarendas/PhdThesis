...
\begin{figure}
	...
	\begin{minipage}{.5\textwidth}
		...
		\captionof{figure}{Kuka AGV OmniMove \\ https://www.kuka.com/en-in/products/mobility} 
		\label{fig:kukaagv}
	\end{minipage}%
	\begin{minipage}{.5\textwidth}
		\centering
		\includegraphics[width=.8\linewidth]{Chapter1/fig/PCW-4}
		\captionof{figure}{Mobile robot with PCW \cite{li2006wheel}} \label{fig:PCWLi}
	\end{minipage}
\end{figure}

\subsection{Redundant mobile robots}\label{sec:RudantrobotLit}
...
\subsection{Obstacle avoidance and path planning}
